      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        <div className="md:col-span-2 space-y-4">
          ...
          <div className="pt-4 space-y-4">
            <Skeleton className="h-5 w-full rounded-md before:duration-1000!" />
            <Skeleton className="h-5 w-10/12 rounded-md before:duration-1000!" />
          </div>
        </div>
      ...
      >
        ...
        <div className="flex flex-wrap gap-2 mb-10">
          {project.tags?.map((tag: string) => (
            <Chip key={tag} size="sm" className="bg-gray-200 text-gray-800 border-none">
              {tag}
            </Chip>
          ))}
        </div>
    ...
    <main className="min-h-screen py-16 bg-gray-50 flex justify-center">
      <div className="max-w-6xl w-full px-4 sm:px-6 lg:px-8">
        ...
        <MotionDiv 
          ...
          className="mb-8"
        >
          <Link href="/projects" className="inline-flex items-center text-sm font-medium text-gray-500 hover:text-black transition-colors group/back hover:underline decoration-1 underline-offset-2">
