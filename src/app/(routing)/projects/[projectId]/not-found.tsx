...
import { MoveLeft, FolderSearch } from "lucide-react";
    ...
    <div className="relative flex flex-col items-center justify-center min-h-[70vh] px-4 text-center overflow-hidden w-full">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none -z-10">
        <svg width="0" height="0" className="absolute pointer-events-none">
          <filter id="inset-shadow-project" x="-20%" y="-20%" width="140%" height="140%">
          ...
          <filter id="inset-shadow-dark-project" x="-20%" y="-20%" width="140%" height="140%">
            <feOffset dx="18" dy="18" in="SourceAlpha" result="offset-dark" />
            <feGaussianBlur stdDeviation="15" in="offset-dark" result="blur-dark" />
            <feComposite operator="out" in="SourceAlpha" in2="blur-dark" result="inverse-dark" />
        ...
        <h1 className="text-[180px] sm:text-[300px] md:text-[380px] lg:text-[450px] font-black tracking-wider leading-none text-background filter-[url(#inset-shadow-project)] dark:filter-[url(#inset-shadow-dark-project)]">  
          4 0 4
        </h1>
      </div>
      ...
      <div className="flex flex-col items-center max-w-lg w-full relative z-10">
        ...
        <p className="text-default-500 text-base md:text-lg mb-10 max-w-md">
          Có vẻ như dự án này đã bị xóa, thay đổi đường dẫn hoặc chưa từng được công bố trong portfolio của tôi.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto items-center justify-center">
          ...
          <Button
            ...
            size="lg"
            className="w-full sm:w-auto font-medium bg-black text-white hover:bg-black/80"
          >
